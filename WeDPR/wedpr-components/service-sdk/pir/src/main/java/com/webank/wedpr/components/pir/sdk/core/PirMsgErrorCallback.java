...
public class PirMsgErrorCallback extends MessageErrorCallback {
    private static final Logger logger = LoggerFactory.getLogger(PirMsgErrorCallback.class);
    private final String method;

    public PirMsgErrorCallback(String method) {
        this.method = method;
    }
